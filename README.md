...
| Package | Status | Description |
|---------|--------|-------------|
| [imager](https://github.com/asgr/imager) | [![R-CMD-check](https://github.com/asgr/imager/actions/workflows/R-CMD-check/badge.svg)](https://github.com/asgr/imager/actions) | Image processing based on Cimg |
